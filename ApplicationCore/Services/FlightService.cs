    ...
    public class FlightService : Service<Flight, FlightDTO, FlightDTO>, IFlightService
    {
        ...
        public async Task generateTicket(string flight_id)
        {
            ...
            for (int i = 1; i <= plane.SeatNum; i++)
            {
                ...
                {
                    case 0:
                        tickets.Add(new Ticket(String.Format("A{0:00}", i), flight_id, null, null,"000"));
                        break;
                    case 1:
                        tickets.Add(new Ticket(String.Format("B{0:00}", i), flight_id, null, null,"000"));
                        break;
                    case 3:
                        tickets.Add(new Ticket(String.Format("C{0:00}", i), flight_id, null, null,"000"));
                        break;
                    default:
                        tickets.Add(new Ticket(String.Format("D{0:00}", i), flight_id, null, null,"000"));
                        break;
                }
            }
