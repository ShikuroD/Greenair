    ...
    public partial class Intital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AirportId = table.Column<string>(maxLength: 5, nullable: false),
                    AirportName = table.Column<string>(maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobName = table.Column<string>(maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketTypeName = table.Column<string>(maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FlightId = table.Column<string>(maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FlightDetailId = table.Column<string>(maxLength: 5, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_FlightDetails_FlightDetailId", x => x.FlightDetailId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlightId = table.Column<string>(nullable: false),
                    AssignedCus = table.Column<string>(maxLength: 25, nullable: true),
